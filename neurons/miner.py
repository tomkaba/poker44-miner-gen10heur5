"""Poker44 miner for standalone gen10heur5 heuristic release."""
...
from poker44.miner_heuristics import get_chunk_scorer_startup_check, score_chunk_gen7heur5
...
class Miner(BaseMinerNeuron):
    """Deterministic chunk scorer for gen10heur5 profile."""

    def __init__(self, config=None):
        super(Miner, self).__init__(config=config)
        bt.logging.info("Heuristic Poker44 Miner started (gen10heur5)")

        chunk_scorer = "gen10heur5"
        bt.logging.info("[init] POKER44_CHUNK_SCORER=gen10heur5 (hardcoded)")
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            defaults={
                "model_name": "poker44_gen10heur5",
                "model_version": "10.5",
                "framework": "python-heuristic",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-gen10heur5",
                "repo_commit": git_commit,
                "notes": "Gen10heur5 profile-based heuristic miner.",
                "open_source": True,
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        bt.logging.info(f"Scored {len(chunks)} chunks with gen10heur5 heuristic.")
        return synapse
    ...
    def score_chunk(self, chunk: list[dict]) -> float:
        return score_chunk_gen7heur5(chunk)[0]
...
if __name__ == "__main__":
    ...
    with Miner() as miner:
        ...
        while True:
            bt.logging.info(
                f"Miner UID: {miner.uid} | Incentive: {float(miner.metagraph.I[miner.uid])} | Scorer: gen10heur5"
            )
            time.sleep(60)
