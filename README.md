# poker44-miner-gen10heur5

Minimal release repository for model gen10heur5.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen10heur5.git
cd poker44-miner-gen10heur5
python3 -m venv .venv
...
- Scorer is hardcoded to `gen10heur5`.
